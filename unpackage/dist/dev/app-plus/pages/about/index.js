...
try {
  components = {
    ...
    ybKeyboard: __webpack_require__(/*! @/components/yb/yb-keyboard/yb-keyboard.nvue */ 142).default
  }
} catch (e) {
  if (
    e.message.indexOf("Cannot find module") !== -1 &&
...
try {
  components = {
    ...
    rdIcon: __webpack_require__(/*! @/components/rd/rd-icon/rd-icon.nvue */ 114).default,
    ybSecurity: __webpack_require__(/*! @/components/yb/yb-security/yb-security.nvue */ 139).default
  }
} catch (e) {
  if (
    e.message.indexOf("Cannot find module") !== -1 &&
